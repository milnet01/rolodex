...
- **ROADMAP.md** — planned work, grouped by priority, each item spec-ready. It is generated
  from the Ants roadmap store: write through `roadmap_log`, because a hand edit is discarded
